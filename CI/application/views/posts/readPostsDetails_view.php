                        ...
                        <div>
                          ...
                          <div class="comment_content">
                            ...
                            <div class="co_comment">
                              <div class="write_co_comment">답글쓰기</div>
                            </div>
                            <!-- 로그인 세션을 갖고 있어야 해당 로직 수행, else는 로그인 페이지로 이동 -->
                            <?php if ($logged_in): ?>
                              <div class="co_comment_form">
                                <!-- 답글 작성 폼 -->
                                <form action="<?php echo base_url('posts/ReadPostsDetails/add_cocomment/' . $comment['id']); ?>"
                                  method="post">
