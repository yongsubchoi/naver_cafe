  ...
  <div class="container">
    ...
    <div class="signUp_form">
      ...
      <?php echo validation_errors(); ?>
        ...
        <div>
          <input type="password" name="password_hash" id="password_hash" placeholder="비밀번호" class="signUp_input_pwd" required>
        </div>
        <div>
          <input type="password" name="password_check" id="password_check" placeholder="비밀번호 확인" class="signUp_input_pwd_check" required>
